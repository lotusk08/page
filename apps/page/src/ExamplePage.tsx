				...
				<nav className="example__sidebar scroll-light">
					<div className="example__sidebar__top">
						<div className="example__sidebar__header">
							<Link
								className="example__sidebar__header__logo"
								to="/"
								aria-label="page.stevehoang.com"
							>
								<SiteLogo />
							</Link>
					...
					<div className="example__sidebar__footer-links">
						...
						<a
							...
							href="https://github.com/lotusk08/page/issues/new?assignees=&labels=Example%20Request&projects=&template=example_request.yml&title=%5BExample Request%5D%3A+"
						>
							<RequestIcon />
...
function SiteLogo() {
	return <span className="example__sidebar__header__wordmark">page.stevehoang.com</span>
}
